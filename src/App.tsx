...
/**
 * Official Verified Social Media Links
 */
export const OFFICIAL_SOCIAL_LINKS = {
  facebook: 'https://www.facebook.com/hotnessyou',
  telegram: 'https://t.me/Hotnessofficial',
  youtube: 'https://youtube.com/@hotnessyou',
  twitter: 'https://x.com/hotness_you',
  instagram: 'https://www.instagram.com/hotnessyou',
  tiktok: 'https://vm.tiktok.com/ZS9AqkXa1y4WQ-vP2Ar/',
} as const;

/**
 * Resolves a social link to ensure it points to the verified official channel
 */
export function resolveSocialUrl(customUrl: string | undefined | null, fallback: string): string {
    ...
    try {
      ...
      if (data && !error) {
        setSiteSettings(prev => ({
          ...prev,
          ...data,
          facebook_url: resolveSocialUrl(data.facebook_url, OFFICIAL_SOCIAL_LINKS.facebook),
          telegram_url: resolveSocialUrl(data.telegram_url, OFFICIAL_SOCIAL_LINKS.telegram),
          youtube_url: resolveSocialUrl(data.youtube_url, OFFICIAL_SOCIAL_LINKS.youtube),
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 pb-6 border-b border-slate-100">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                ...
                {/* Facebook */}
                <a 
                  href={resolveSocialUrl(siteSettings.facebook_url, OFFICIAL_SOCIAL_LINKS.facebook)} 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  title="Facebook - @hotnessyou"
                  className="w-9 h-9 rounded-xl bg-[#1877F2]/10 hover:bg-[#1877F2] text-[#1877F2] hover:text-white flex items-center justify-center transition-all duration-200 border border-[#1877F2]/20 hover:scale-110 shadow-sm cursor-pointer"
                  onClick={(e) => {
                    e.stopPropagation();
                  }}
                >
                ...
                {/* Telegram */}
                <a 
                  href={resolveSocialUrl(siteSettings.telegram_url, OFFICIAL_SOCIAL_LINKS.telegram)} 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  title="Telegram - @Hotnessofficial"
                  className="w-9 h-9 rounded-xl bg-[#229ED9]/10 hover:bg-[#229ED9] text-[#229ED9] hover:text-white flex items-center justify-center transition-all duration-200 border border-[#229ED9]/20 hover:scale-110 shadow-sm cursor-pointer"
                  onClick={(e) => {
                    e.stopPropagation();
                  }}
                >
                ...
                {/* YouTube */}
                <a 
                  href={resolveSocialUrl(siteSettings.youtube_url, OFFICIAL_SOCIAL_LINKS.youtube)} 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  title="YouTube - @hotnessyou"
                  className="w-9 h-9 rounded-xl bg-[#FF0000]/10 hover:bg-[#FF0000] text-[#FF0000] hover:text-white flex items-center justify-center transition-all duration-200 border border-[#FF0000]/20 hover:scale-110 shadow-sm cursor-pointer"
                  onClick={(e) => {
                    e.stopPropagation();
                  }}
                >
                ...
                {/* Twitter / X */}
                <a 
                  href={resolveSocialUrl(siteSettings.twitter_url, OFFICIAL_SOCIAL_LINKS.twitter)} 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  title="X (Twitter) - @hotness_you"
                  className="w-9 h-9 rounded-xl bg-slate-900/10 hover:bg-slate-900 text-slate-900 hover:text-white flex items-center justify-center transition-all duration-200 border border-slate-900/20 hover:scale-110 shadow-sm cursor-pointer"
                  onClick={(e) => {
                    e.stopPropagation();
                  }}
                >
                  <svg className="w-3.5 h-3.5 fill-current pointer-events-none" viewBox="0 0 24 24">
                ...
                {/* Instagram */}
                <a 
                  href={resolveSocialUrl(siteSettings.instagram_url, OFFICIAL_SOCIAL_LINKS.instagram)} 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  title="Instagram - @hotnessyou"
                  className="w-9 h-9 rounded-xl bg-[#E4405F]/10 hover:bg-[#E4405F] text-[#E4405F] hover:text-white flex items-center justify-center transition-all duration-200 border border-[#E4405F]/20 hover:scale-110 shadow-sm cursor-pointer"
                  onClick={(e) => {
                    e.stopPropagation();
                  }}
                >
                ...
                {/* TikTok */}
                <a 
                  href={resolveSocialUrl(siteSettings.tiktok_url, OFFICIAL_SOCIAL_LINKS.tiktok)} 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  title="TikTok - @hotness"
                  className="w-9 h-9 rounded-xl bg-black/10 hover:bg-black text-slate-900 hover:text-white flex items-center justify-center transition-all duration-200 border border-slate-900/20 hover:scale-110 shadow-sm cursor-pointer"
                  onClick={(e) => {
                    e.stopPropagation();
                  }}
                >
